...
def main(project_directory, input_file, grid = 'L', counts_threshold=1):
    ...
    try:
        ...
        tally_dict, properties_dict = enrich_util.build_tally_dict(project_directory + 'data/tmp/' + input_file, counts_threshold=counts_threshold)
